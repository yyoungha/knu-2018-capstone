...
public class AlarmsAdapter extends BaseAdapter {
    ...
    private ArrayList<AlarmsData> m_oData = null;
    private int nListCnt = 0;

    public AlarmsAdapter(ArrayList<AlarmsData> _oData) {
        m_oData = _oData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_adapter_alarmlist, parent, false);
        }
